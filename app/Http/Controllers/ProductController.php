...
class ProductController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        $product->delete();
        return redirect()->back()->with(['success' => '<strong>' . $product->name . '</strong> Telah di-Hapus !']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect(route('produk.index'))->with(['success' => '<strong>' . $product->name . '</strong> Di-Perbaharui']);
        } catch (\Exception $e) {
            return redirect()->back()->with(['error' => $e->getMessage()]);
        }
    }
