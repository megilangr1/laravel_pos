            ...
            @card
              ...
              <form action="{{ route('produk.update', $product->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="code" id="code" maxlength="10" readonly="" value="{{ $product->code }}" class="form-control {{ $errors->has('code') ? 'is-invalid':'' }}">
                ...
                <div class="form-group">
                  ...
                  <select name="category_id" id="category_id" class="form-control {{ $errors->has('kategori') ? 'is-invalid':'' }}" required>
